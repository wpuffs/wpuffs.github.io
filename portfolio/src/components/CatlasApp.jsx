...
function CatlasApp() {
  return (
    <div className="page">
        ...
        <h1><b>CATLAS: Community Cat Tracking Application</b></h1>
        ...
        <h3><b>Early stages of Catlas</b></h3>
        ...
        <h3><b>Testing our initial design</b></h3>
        ...
        <FigmaEmbed 
            src="https://embed.figma.com/proto/X835swGWhI2UAFFChnkHM9/11_G2-Hi-Fi-Prototype?page-id=487%3A57&node-id=487-5215&p=f&viewport=318%2C513%2C0.03&scaling=scale-down&content-scaling=fixed&starting-point-node-id=487%3A5215&embed-host=share"/>
        <p></p>
        
        <h2><b>Lastly, a reflection</b></h2>
